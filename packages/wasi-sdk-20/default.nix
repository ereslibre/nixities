...
in
  pkgs.stdenv.mkDerivation {
    ...
    in (
      ...
      then let
        system = mapSystem stdenv.hostPlatform.system;
      in
        pkgs.fetchurl {
          url = "https://github.com/WebAssembly/${pname}/releases/download/${pname}-${version}/${pname}-${version}.0-${system.tarballSuffix}.tar.gz";
          hash = system.hash;
        }
